...
const dashboard_service_1 = require("../../services/userServices/dashboard.service");
    ...
    constructor() {
        ...
        this.getDashboardStats = async (req, res, next) => {
            try {
                ...
                res.success(response_messages_1.ResponseMessages.USER_DASHBOARD_STATS_FOUND, data);
            }
            catch (error) {
                next(error);
            }
